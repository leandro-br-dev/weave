...
export default function LoginPage() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 ${withDarkMode('bg-gray-100', 'bg-gray-900')}`}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className={`text-2xl font-bold ${withDarkMode('text-gray-900', 'text-white')}`}>
            {t('common.app.title')}
          </h1>
        </div>

        {/* Login Card */}
        <div className={`rounded-xl border p-8 ${withDarkMode('bg-white border-gray-200', 'bg-gray-800 border-gray-700')}`}>
          <div className="text-center mb-6">
            <h2 className={`text-xl font-semibold ${withDarkMode('text-gray-900', 'text-white')}`}>
              {t('auth.login.title')}
            </h2>
            <p className={`text-sm mt-1 ${withDarkMode('text-gray-500', 'text-gray-400')}`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Password */}
            <div>
              <label htmlFor="password" className={`block text-sm font-medium mb-1 ${withDarkMode('text-gray-700', 'text-gray-300')}`}>
        ...
        {!hasUsers && (
          <div className="text-center mt-6">
            <p className={`text-sm mb-2 ${withDarkMode('text-gray-500', 'text-gray-400')}`}>
